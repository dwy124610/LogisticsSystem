...
import com.dwy.logistics.model.entities.OrdersExample.Criteria;
import com.dwy.logistics.model.entities.OrdersExample.Criterion;
...
public class OrdersSqlProvider {
    ...
    public String updateByPrimaryKeySelective(Orders record) {
        ...
        if (record.getStartPlaceID() != null) {
            sql.SET("startPlaceID = #{startPlaceID,jdbcType=VARCHAR}");
        }
        
        if (record.getEndPlaceID() != null) {
            sql.SET("endPlaceID = #{endPlaceID,jdbcType=VARCHAR}");
        }
        ...
        if (record.getGoodsNumber() != null) {
            sql.SET("goodsNumber = #{goodsNumber,jdbcType=INTEGER}");
        }
